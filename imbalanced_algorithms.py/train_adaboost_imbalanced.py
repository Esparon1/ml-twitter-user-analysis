...
print("🚀 Training AdaBoost model on imbalanced data...")

# Entraînement du modèle
model = AdaBoostClassifier(estimator=DecisionTreeClassifier(max_depth=1), n_estimators=50, learning_rate=0.1, random_state=42)
...
print(f" AdaBoost (Imbalanced) Accuracy: {accuracy:.4f}")
