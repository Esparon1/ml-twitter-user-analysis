...
#  Load training and testing datasets (use correct paths)
try:
...
try:
    ...
    class_report = classification_report(y_test, y_pred, target_names=["Legitimate", "Polluter"])  # ✅ FIXED
    ...
    print(f"1-score for Polluters: {class_report.split()[-2]}")
